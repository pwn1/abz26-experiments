...
template_file = "main_assertions.csp"  # The source file with placeholders
log_file_name = "fdr_sweep.log"
...
parameters = {
    ...
    'alpha': [8],
    'K': [1],
    'D': [0,10,20,40,80,100,200,400,800,1000]
}

# Map the parameter keys to the string constants of the .csp file
const_map = {
    'av': 'const_Movement_av',
    'lv': 'const_Movement_lv',
    'alpha': 'const_Movement_alpha',
    'K': 'const_Movement_K',
    'D': 'const_aux_D'
}
